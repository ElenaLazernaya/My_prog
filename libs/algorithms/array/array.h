...
//нахождение суммы элементов массива а
int getSum(int *a, int n);

//new нахождение макс элемента массива а
int getMax(int *a, int n);

//new нахождение мин элемента массива а
int getMin(int *a, int n);


//new 13
//проверяет, упорядочены ли элементы по неубыванию
bool isNonDescendingSorted(int *a, int n);

//new 16
//проверяет, является ли элемент на позиции k особый, т.е. слева от него находятся только
//меньшие элементы, а справа – только бoльшие
bool isSpecialElement(int *a, int n,int k);
